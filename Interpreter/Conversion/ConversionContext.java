...
public class ConversionContext {
    ...
    public String getLowercase(String wordToLowercase){
    	...
    	int lengthOfWord = wordToLowercase.length();
    	
    	if((wordToLowercase.charAt(lengthOfWord -1)) != 's'){
    		
    		wordToLowercase = new StringBuffer(wordToLowercase).insert(lengthOfWord, "s").toString();
